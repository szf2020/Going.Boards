...
{
    public class I2CDevicePI : II2CDevice
    {
        private I2CBusPI _bus;
        private byte _deviceAddress;

        public I2CDevicePI(I2CBusPI bus, byte deviceAddress)
        {
            _bus = bus;
        ...
        */
        ...
        public void WriteBytes(byte regAddr, byte[] data)
        {
            _bus.WriteBytes(_deviceAddress, regAddr, data);
        }
